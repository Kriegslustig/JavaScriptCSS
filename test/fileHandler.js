...
describe('fileHandler', function () {
  ...
  describe('write', function () {
    ...
    it('Should overwrite a file if it already exists', function () {
      fileHandler.write(testFile, 1 + testString + 1)
      assert.equal(1 + testFile + 1, fs.readFileSync(testFile, {encoding: 'utf8'}))
    })
    after(function () {
      fs.unlink(testFile)
    })
